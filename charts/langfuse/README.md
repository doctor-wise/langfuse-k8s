...
![Version: 3.170.0](https://img.shields.io/badge/Version-3.170.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.170.0](https://img.shields.io/badge/AppVersion-3.170.0-informational?style=flat-square)
...
| postgresql.auth.secretKeys | object | `{"adminPasswordKey":"password","userPasswordKey":"password"}` | The keys in the existing secret that contain the passwords. If using the default `postgres` user, both `userPasswordKey` and `adminPasswordKey` must be provided. |
